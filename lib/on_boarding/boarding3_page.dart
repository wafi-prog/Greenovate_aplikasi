...
import 'package:greenovate/screens/login_screen.dart';
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Bareng-Bareng, Kita Bisa Bikin Perubahan!',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(height: 12),
                  const Text(
                    'Ikut gerakan, tantangan, dan kegiatan seru seputar lingkungan. Yuk gabung komunitas hijau Greenovate!',
                    textAlign: TextAlign.center,
